...
Так как имеются сложности с ресурсами, то есть, мы не сможем одновременно держать старые и новые версии подов (что отметает сразу варианты Rolling Update/BlueGreen/Canary и A/B) и новые версии приложения не работают вместе с старыми (что отметает вариант с Cannary Deployment), я бы остановился на способе Recreate. Будет короткое окно недоступности, однако изменения произойдут быстро и в случае каких-то проблем возможен моментальный откат к старой версии.
...
Файлы в папке task_3:
https://github.com/Rikolleti/git-2-k8s/tree/master/homework_6/task_3

Результат:

<img width="947" height="343" alt="Снимок экрана 2025-12-07 в 22 40 17" src="https://github.com/user-attachments/assets/8b03662f-f361-400d-ad18-846d72db251c" />
